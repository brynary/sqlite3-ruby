...
<untrusted-9c0e0daf2103571f>
{
  "name": "sweep:1",
  "job_id": "sweep:1",
  "kind": "sweep",
  "ask": "Look for entry points and dangerous sinks outside the covered paths: scripts, configuration, CI definitions, migrations, admin tooling, and glue code.",
  "coveredPaths": "ext/sqlite3/database.c, ext/sqlite3/database.h, ext/sqlite3/statement.c, ext/sqlite3/statement.h, ext/sqlite3/sqlite3_ruby.h, ext/sqlite3/sqlite3.c, ext/sqlite3/exception.c, ext/sqlite3/exception.h, lib/sqlite3/database.rb, lib/sqlite3/statement.rb, lib/sqlite3/resultset.rb, lib/sqlite3/value.rb, lib/sqlite3.rb, lib/sqlite3/pragmas.rb, lib/sqlite3/translator.rb, lib/sqlite3/constants.rb, lib/sqlite3/errors.rb, lib/sqlite3/version.rb, ext/sqlite3/extconf.rb, tasks/vendor_sqlite3.rake, tasks/native.rake, tasks/faq.rake, Rakefile, setup.rb, faq/faq.rb, faq/faq.yml",
  "target": {
    "mode": "scan",
    "scope": [],
    "range": null,
